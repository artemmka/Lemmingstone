...
- Кулдаун использования карточек равен 20 секундам.
...
#### 2.2.2. Карточка «Лопата»
- Особая способность, позволяющая леммингу копать вокруг себя в ограниченном радиусе.
- Радиус копания - 30 пикселей
...
- Передвижение - a,d,s
- Прыжок - space
- Карта способности - XZ(Х - для класса "Разведчик")
