...
- Количество очков опыта на дереве будет спавниться случайным образом от 5 до 20.
...
- Для прменения карточки способностей используется ER(E - 1-ая карточка, R - 2-ая карточка)
#### 4.3.2. Управление за класс "Разведчик"
- Для передвижения лемминга используются клавиши AD(A - движение влево, D - движение вправо).
- Для прыжка используется клавиша space
- Для прменения карточки способностей используется E(E - 1-ая карточка)
