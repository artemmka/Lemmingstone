...
- Атака вверх – совершает небольшой прыжок и наносит урон над собой в радиусе 100 пикселей.
...
- При падении лемминга ниже уровня земли он автоматически погибает.
#### 2.10. Разрушаемость карты
...
#### 4.3. Управление за каждый класс
#### 4.3.1. Управление за класс "Силач"
- Для передвижения лемминга используются клавиши AD(A - движение влево, D - движение вправо).
- Для прыжка используется клавиша space
- Для применения карточки способностей используется ER(E - 1-ая карточка, R - 2-ая карточка)
#### 4.3.2. Управление за класс "Разведчик"
- Для передвижения лемминга используются клавиши AD(A - движение влево, D - движение вправо).
- Для прыжка используется клавиша space
- Для применения карточки способностей используется E(E - 1-ая карточка)
